...
const MAC =[
    {key:'MAC less than 21', value:'MAC less than 21'},
    {key:'MAC 21 to 22', value:'MAC 21 to 22'},
    {key:'MAC greater than 22', value:'MAC greater than 22'},
    
]

const CC =[
    {key:'CC less than 31', value:'CC less than 31'},
    {key:'CC 31 or greater', value:'CC 31 or greater'}
]
const fluid =[
                            ...
                            <div className="bg-gray-5 flex flex-col gap-6 pt-6 pb-8">
                                    <div className="flex flex-col gap-6">
                                        <div className="px-5 flex flex-col gap-7">
                                            <p className="text-sm font-semibold">Mid-arm circumference (MAC) in cm</p>
                                            <FormikControl control="radio" name="MAC" options={MAC} />
                                            <ErrorMessage component={TextError} name="MAC" />
                                        </div>
                                    ...
                                    <div className="flex flex-col gap-6">
                                        <div className="px-5 lex flex-col gap-7">
                                            <p className="text-sm font-semibold">Calf circumference (CC) in cm</p>
                                            <FormikControl control="radio" name="CC" options={CC} />
                                            <ErrorMessage component={TextError} name="CC" />
                                        </div>
                                        <div className='relative'>
                                            <p className='absolute right-3'>Score:</p>
                                        </div>
